...
| k8gb.dnsZone | string | `"cloud.example.com"` |  |
...
| k8gb.imageRepo | string | `"absaoss/k8gb"` | image repo, image tag defaults to Chart.AppVersion, see Chart.yaml, but can be overrided with imageTag key |
